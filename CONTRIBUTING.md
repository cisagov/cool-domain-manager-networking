...
issue](https://github.com/cisagov/cool-domain-manager-networking/issues) in this
...
request](https://github.com/cisagov/cool-domain-manager-networking/pulls), you
...
```console
cd cool-domain-manager-networking
pyenv virtualenv <python_version_to_use> cool-domain-manager-networking
pyenv local cool-domain-manager-networking
